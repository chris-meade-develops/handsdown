...
export default function Pricing({
  ...
  return (
    <div className="w-full rounded-[15px] relative overflow-hidden flex flex-col justify-between mb-19 bg-white">
      <div className="relative flex-col justify-center w-full text-center pt-25 px-17 font-montserrat md:mb-28">
        {highlight && (
        ...
        <div className="flex items-end justify-center text-primary-text md:mb-14">
          <span className="text-5xl md:text-[51px] font-semibold ">{pricing}</span>
